var pgNPC;
function PGNPC(){
	this.imgEnemySpadeRight = resourcePreLoader.GetImage("img/game_enemy_dia_right.png");
	this.imgEnemySpadeLeft = resourcePreLoader.GetImage("img/game_enemy_dia_left.png");
	this.imgEnemySpadeRightDead = resourcePreLoader.GetImage("img/game_enemy_dia_right_dead.png");
	this.imgEnemySpadeLeftDead = resourcePreLoader.GetImage("img/game_enemy_dia_left_dead.png");
